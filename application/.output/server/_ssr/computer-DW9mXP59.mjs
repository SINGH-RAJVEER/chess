import { h as createSignal, d as createMemo, s as ssr, t as escape, b as createComponent, p as ssrHydrationKey, w as ssrAttribute, S as Show, F as For, q as ssrStyleProperty } from "../_libs/solid-js.mjs";
import { u as useQueryClient, b as useQuery, c as useMutation } from "../_chunks/_libs/@tanstack/solid-query.mjs";
import { H as Header, g as getBoard, m as makeMove, u as undoMove, r as resetGame } from "./header-DQFIH7Ut.mjs";
...
function ComputerGame() {
  ...
  return ssr(_tmpl$9, ssrHydrationKey(), escape(createComponent(Header, {
    ...
    children: (p) => ssr(_tmpl$0, ssrHydrationKey(), `Captured ${escape(p, true)}`, escape(PIECE_SYMBOLS.White[p]))
    ...
    children: (_, index) => {
      ...
      return ssr(_tmpl$11, ssrHydrationKey(), `${`relative w-full h-full flex items-center justify-center focus:outline-none transition-colors duration-200 ${isBlack ? escape(darkSquareColor, true) : escape(lightSquareColor, true)}` || ""} ${selectedSquare() === squareIndex ? "ring-inset ring-[6px] ring-indigo-500/60 z-10" : ""} ${!selectedSquare() || selectedSquare() !== squareIndex ? "hover:brightness-105" : ""}`, escape(createComponent(Show, {
        when: col === 0,
        get children() {
          return ssr(_tmpl$1, ssrHydrationKey(), `absolute left-1 top-1 text-[10px] sm:text-xs font-black ${isBlack ? "text-[#f0d9b5]" : "text-[#b58863]"} opacity-60`, 8 - escape(row));
        }
      })), escape(createComponent(Show, {
        when: row === 7,
        get children() {
          return ssr(_tmpl$1, ssrHydrationKey(), `absolute right-1 bottom-0.5 text-[10px] sm:text-xs font-black ${isBlack ? "text-[#f0d9b5]" : "text-[#b58863]"} opacity-60`, escape(String.fromCharCode(97 + col)));
        }
      })), escape(createComponent(Show, {
        get when() {
          return isLastMove();
        ...
        get children() {
          return (() => {
            ...
            return hasPiece ? ssr(_tmpl$12, ssrHydrationKey()) : ssr(_tmpl$13, ssrHydrationKey());
          })();
        }
      })), (() => {
        ...
        return escape(createComponent(Show, {
          when: piece,
          get children() {
            return ssr(_tmpl$14, ssrHydrationKey(), ssrStyleProperty("color:", piece.color === "White" ? "#ffffff" : "#1a1a1a") + ssrStyleProperty(";text-shadow:", piece.color === "White" ? "0 2px 4px rgba(0,0,0,0.4)" : "0 2px 4px rgba(255,255,255,0.1)"), escape(PIECE_SYMBOLS[piece.color][piece.piece_type]));
          }
        }));
      })());
    }
    ...
    children: (p) => ssr(_tmpl$0, ssrHydrationKey(), `Captured ${escape(p, true)}`, escape(PIECE_SYMBOLS.Black[p]))
  })), escape(createComponent(Show, {
    get when() {
    ...
    get children() {
      return ssr(_tmpl$6, ssrHydrationKey(), ssrAttribute("disabled", undoMutation.isPending || (boardQuery.data?.moves?.length || 0) === 0, true));
    }
  })), escape(createComponent(Show, {
    get when() {
    ...
    get children() {
      return ssr(_tmpl$8, ssrHydrationKey(), ssrAttribute("disabled", moveMutation.isPending, true), escape(createComponent(Show, {
        get when() {
