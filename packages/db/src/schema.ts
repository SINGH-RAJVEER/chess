...
export const games = pgTable("games", {
	...
	whiteTimeRemaining: bigint("white_time_remaining", { mode: "number" }).notNull().default(600000),
	blackTimeRemaining: bigint("black_time_remaining", { mode: "number" }).notNull().default(600000),
